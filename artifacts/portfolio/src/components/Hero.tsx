  ...
  return (
    <section className="relative min-h-screen w-full flex items-center overflow-hidden bg-background">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(17,51,71,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(17,51,71,0.5) 1px, transparent 1px)`,
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <motion.a
                ...
                whileHover={{ scale: 1.04, boxShadow: "0 0 30px rgba(17,51,71,0.4)" }}
                whileTap={{ scale: 0.97 }}
                className="px-8 py-4 bg-primary text-white font-semibold rounded-full text-sm tracking-wide shadow-[0_0_20px_rgba(17,51,71,0.3)] transition-all cursor-pointer"
