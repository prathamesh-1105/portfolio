  ...
  return (
    <section id="ai-clone" className="relative py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          <div className="rounded-3xl border border-primary/20 bg-black/40 backdrop-blur-xl overflow-hidden shadow-[0_0_60px_rgba(66,108,132,0.1)]">
            ...
            <div className="h-80 overflow-y-auto p-6 flex flex-col gap-4 scroll-smooth" style={{ scrollbarWidth: "thin", scrollbarColor: "rgba(66,108,132,0.2) transparent" }}>
              <AnimatePresence>
                {messages.map((msg, i) => (
                  <motion.div
                    key={i}
